...
import 'package:ism/Login/email_otp_verify.dart';
...
class LoginWithEmailOTP extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _LoginWithEmailOTPState();
  }
}
  ...
  void _signUpProcess(BuildContext context) async {
    ...
    try {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => RegistationVarification(
                    email: "ravidev.cotocus@gmail.com",
                    otp: "123456",
                    phone: "9865325698",
                    deviceId: "hyfgsgdhgjhsgfdsf64s654sfdgsd54df54hg",
                    name: "Ravi",
                  )));
