...
class Pending_ScreenSubmit extends StatefulWidget {
  String sub_offered_id, session, sessionyear, date, priod, sub_id, proid;

  Pending_ScreenSubmit(
  ...
  @override
  _Pending_ScreenSubmitState createState() => _Pending_ScreenSubmitState();
}

class _Pending_ScreenSubmitState extends State<Pending_ScreenSubmit> {
  String totalStudent = '';
  String _search = '';
  String? _classtime;
  ...
  void _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 400), () {
      _LoadAssignClassSerch(_searchController.text);
    });
  }
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData is Map<String, dynamic> &&
          ...
          setState(() {
            ...
            presentStudent = PresentStudentList.length;
          });
        } else {
  ...
  Future<void> _LoadAssignClassSerch(String _search) async {
    setState(() {
      isLoading = true;
    });
    ...
    try {
      ...
      setState(() {
        _classtime = preferences.getString('classtime');
        otp = preferences.getString('otpnew') ?? '';
      });
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("Present : $presentStudent",
                                  style: TextStyle(fontSize: 18)),
                              Text("Absent : $absentStudent",
                                  style: TextStyle(fontSize: 18)),
                            ],
                          ),
                        ),
                                  ...
                                  /* Expanded(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: AllStudentList[index].image !=
                                                  null
                                              ? Image.network(
                                                  AllStudentList[index].image!,
                                                  fit: BoxFit.cover,
                                                )
                                              : Image.asset(
                                                  "assets/images/image1.jpg",
...
*/
  ...
  void AbsentAlert(BuildContext context, index, admn, classpriod, status) {
  ...
  Future<void> updadateclasstimme(String updatetime) async {
    try {
      ...
      //             sub_offered_id: widget.sub_offered_id.toString(),
      //             session: widget.session.toString(),
      //             sessionyear: widget.sessionyear.toString(),
      //           )),
      // );
    } catch (err) {
      print('An error occurred: $err');
