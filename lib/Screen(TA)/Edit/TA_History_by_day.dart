// ignore_for_file: file_names, prefer_const_constructors, camel_case_types, use_key_in_widget_constructors, depend_on_referenced_packages
...
class TA_AttendanceByDay extends StatefulWidget {
  @override
  _TA_AttendanceByDayState createState() => _TA_AttendanceByDayState();
}

class _TA_AttendanceByDayState extends State<TA_AttendanceByDay> {
  ...
  Future<void> _LoadAssignClass(DateTime date) async {
    ...
    try {
      ...
      final Uri uri = isNEP
          ? Uri.parse(
              '${ApiConstants.baseUrl}nep_Total_class_date_TA') // If isNEP is true
          : Uri.parse(
              '${ApiConstants.baseUrl}Total_class_date_TA'); // If isNEP is false

      // final Uri uri = Uri.parse('${ApiConstants.baseUrl}Total_class_date_TA');
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => TA_Dealy_AttendanceScreen(
                                ...
                                date: selectedDay!,
                                priods:
                                    CourseList[index].classPeriods.toString(),
                                dates: currentdate,
                                proId: CourseList[index].engagedBy.toString(),
                              )),
                    );
